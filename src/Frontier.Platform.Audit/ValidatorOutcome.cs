...
/// <summary>
/// The result of a Check agent's validation run against an artifact (doc 05 §3, §7 query 2).
...
public sealed record ValidatorOutcome
{
    ...
    /// <summary>The artifact key the validator ran against.</summary>
    [JsonPropertyOrder(2)]
    [JsonPropertyName("target_artifact_key")]
    public required string TargetArtifactKey { get; init; }
