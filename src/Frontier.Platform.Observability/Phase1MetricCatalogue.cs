...
internal sealed class Phase1MetricCatalogue : IMetricCatalogue, IDisposable
{
    ...
    [
        ...
        new("context.cost.saved",        MetricInstrumentType.Counter,          "{cost}", ["engagement_type", "currency"],   "Cache-read vs. full-price delta in the ISO 4217 currency named by the currency attribute (ADR-PA21: never summed across currencies); continuously measures the 40–50% cost-saving claim."),
